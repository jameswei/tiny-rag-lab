...
| **RagTrace** | `query`, `retrieved_chunks`, `prompt`, `answer`, `citations`, `latency_by_stage` | `cli.cmd_ask()` | 终端输出（Phase 1），磁盘存储（Phase 1.7） |
...
rag retrieve "问题" --index-dir .tiny-rag/index --top-k 5
rag ask "问题" --index-dir .tiny-rag/index --top-k 5
