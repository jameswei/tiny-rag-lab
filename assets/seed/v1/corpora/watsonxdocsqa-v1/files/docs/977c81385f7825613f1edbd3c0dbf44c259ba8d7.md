 ...
 *  [Requirements and restrictions](https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/search-assets.html?context=cdpaas&locale=en#restrictions)
 *  [Searching for assets](https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/search-assets.html?context=cdpaas&locale=en#search)
 *  [Selecting results](https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/search-assets.html?context=cdpaas&locale=en#result)
 ...
 *  [Searching for the start of a word](https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/search-assets.html?context=cdpaas&locale=en#start)
 *  [Searching for a part of a word](https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/search-assets.html?context=cdpaas&locale=en#part)
 *  [Searching for a phrase](https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/search-assets.html?context=cdpaas&locale=en#phrase)
 *  [Searching for multiple alternative words](https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/search-assets.html?context=cdpaas&locale=en#multiple)
